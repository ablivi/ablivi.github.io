...
const Products = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      title: "Gaming Laptop - High Performance RGB Backlit",
      price: "899.00",
      minOrder: "10 pieces",
      supplier: "GamingTech Pro",
      rating: 4.9,
      badge: "Premium"
    },
    {
      ...
      title: "Mechanical Gaming Keyboard - RGB LED Switches",
      price: "68.00",
      minOrder: "50 pieces",
      supplier: "KeyMaster",
      rating: 4.7,
    ...
    },
    {
      id: "prod-23",
      image: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=400&h=400&fit=crop",
      title: "Polarized Aviator Sunglasses - Metal Frame",
      price: "15.99",
      minOrder: "150 pieces",
      supplier: "EyeStyle Co.",
      rating: 4.6,
    },
    {
      id: "prod-24",
      image: "https://images.unsplash.com/photo-1434494878577-86c23bcb06b9?w=400&h=400&fit=crop",
      title: "Women's Yoga Leggings - High Waist Compression",
      price: "18.50",
      minOrder: "200 pieces",
      supplier: "ActiveWear Plus",
      rating: 4.8,
      badge: "Hot Sale"
    },
    {
      ...
      title: "Men's Leather Jacket - Genuine Premium Quality",
      price: "125.00",
      minOrder: "30 pieces",
      supplier: "LeatherCraft Ltd.",
      rating: 4.9,
      badge: "Premium"
    },
    {
      id: "prod-26",
      image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop",
      title: "Running Shoes - Cushioned Sole Technology",
      price: "42.00",
      minOrder: "100 pieces",
      supplier: "RunPro Athletics",
      rating: 4.7,
    },
    {
      id: "prod-27",
      image: "https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=400&h=400&fit=crop",
      title: "LED Ring Light - Photography & Video Studio",
      price: "35.00",
      minOrder: "60 pieces",
      supplier: "StudioGear",
      rating: 4.6,
    ...
    },
    {
      id: "prod-28",
      image: "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=400&h=400&fit=crop",
      title: "Waterproof Hiking Backpack - 50L Capacity",
      price: "55.00",
      minOrder: "70 pieces",
      supplier: "OutdoorGear Pro",
      rating: 4.8,
    },
    {
      id: "prod-29",
      image: "https://images.unsplash.com/photo-1616627547584-bf28cfeac7db?w=400&h=400&fit=crop",
      title: "Smart Home Security Camera - 1080P WiFi",
      price: "48.00",
      minOrder: "80 pieces",
      supplier: "SecureHome Tech",
      rating: 4.7,
      badge: "Hot Sale"
    },
    {
      id: "prod-30",
      image: "https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=400&h=400&fit=crop",
      title: "Electric Toothbrush - Sonic Technology USB",
      price: "28.00",
      minOrder: "100 pieces",
      supplier: "DentalCare Plus",
      rating: 4.5,
    },
    {
      id: "prod-31",
      image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=400&fit=crop",
      title: "Over-Ear Studio Headphones - Professional Audio",
      price: "89.00",
      minOrder: "40 pieces",
      supplier: "AudioStudio Pro",
      rating: 4.9,
      badge: "Premium"
    },
    {
    ...
    },
    {
      id: "prod-34",
      image: "https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=400&h=400&fit=crop",
      title: "Premium Cotton Hoodie - Unisex Pullover",
      price: "24.00",
      minOrder: "200 pieces",
      supplier: "ComfortWear",
      rating: 4.5,
    },
    {
      id: "prod-35",
      image: "https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=400&h=400&fit=crop",
      title: "Adjustable Laptop Stand - Ergonomic Design",
      price: "29.00",
      minOrder: "90 pieces",
      supplier: "ErgoDesk",
      rating: 4.6,
    ...
    },
    {
      ...
      title: "Fitness Resistance Bands Set - 5 Levels",
      price: "16.50",
      minOrder: "120 pieces",
